...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 22 12:33:54 2023
...
filename = 'stone_comparison_TDE.fits'

output_table = Table.read(TDE_results_dir+filename)

lograds = np.log10(output_table['radii'].value[0])
logdens = np.log10(output_table['dens'].value[0])
plt.figure(dpi=600)
plt.plot(lograds,logdens)
plt.ylim(-50,2)

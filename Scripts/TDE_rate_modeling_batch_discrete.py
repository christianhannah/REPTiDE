...
# -*- coding: utf-8 -*-
"""
Created on Fri May 12 16:50:22 2023
...
def get_TDE_rate(name,dens_rad,dens,M_BH):
...
# =============================================================================
    ...
    def ensure_psi_r_covers_psi_t(psi_t_min,psi_t_max):
        ...
        while not coverage_met:
            ...
            psi_r_temp,psi_bh_temp,psi_enc_temp,psi_ext_temp = \
                tu.get_psi_r_discrete(r_temp,M_BH,dens_rad,dens,toy_model_match)
    ...
    psi_r_init,psi_bh_init,psi_enc_init,psi_ext_init = tu.get_psi_r_discrete(r_ls,M_BH,dens_rad,dens,toy_model_match)
    rho_r_init = tu.get_rho_r_discrete(r_ls,dens_rad,dens,toy_model_match)
            ...
            def get_drhodpsi(d_rho_d_psi_t,drhodpsi_ratios):
                for i in range(len(psi_t)):
                    if psi_t[i] >= 1e-20:
                        ...
                        rho_r = tu.get_rho_r_discrete(r,dens_rad,dens,toy_model_match)
...
# =============================================================================
    ...
    def compute_q():
        ...
        for i in range(len(orb_ens)):
            ...
            psi_r_ref,psi_bh_ref,psi_enc_ref,psi_ext_ref = tu.get_psi_r_discrete(r_ref,M_BH,dens_rad,dens,toy_model_match)

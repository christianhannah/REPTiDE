...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 17:29:40 2023

Code to compute TDE rates for a batch of density profiles.
...
def get_TDE_rate(name,slope,r_b,rho_b,smooth,M_BH,decay_params):
